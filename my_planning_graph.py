...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return len(eff_a1_rem.intersection(precond_a2_pos)) > 0 or len(
            eff_a1_add.intersection(precond_a2_neg)) > 0 or len(eff_a2_rem.intersection(precond_a1_pos)) > 0 or len(
            eff_a2_add.intersection(precond_a1_neg)) > 0
